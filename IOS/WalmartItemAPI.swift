public class WalmartItemAPI: NSObject  {
    ...
    static let kRequestAddItem = "com.HttpClientApi.ern.api.request.addItem";

    static let kRequestFindItems = "com.HttpClientApi.ern.api.request.findItems";
    static let kEventItemAdded = "com.HttpClientApi.ern.api.event.itemAdded";
