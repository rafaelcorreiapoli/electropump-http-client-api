...
public final class WalmartItemApi {
    ...
    public interface Events {
        String EVENT_ITEM_ADDED = "com.HttpClientApi.ern.api.event.itemAdded";
    ...
    public interface Requests {
        String REQUEST_ADD_ITEM = "com.HttpClientApi.ern.api.request.addItem";
        String REQUEST_FIND_ITEMS = "com.HttpClientApi.ern.api.request.findItems";
